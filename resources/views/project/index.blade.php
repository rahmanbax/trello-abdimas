...
<body class="bg-slate-100">
    ...
    <div class="my-6 mx-5 lg:mx-20">
        <div class="flex justify-between">
            <h2 class="text-2xl font-semibold">Daftar Proyek</h2><button id="add-project-btn"
                class="font-medium place-self-end flex items-center gap-2 py-2 px-3 text-white bg-blue-600 hover:bg-blue-500 shadow-sm rounded-md"><i
                    class="ph-bold ph-plus"></i>Tambah proyek</button>
        </div>
            ...
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div
                    ...
                    <div class="">
                        ...
                        <div class="text-left">
                            <label for="projectname" class="text-base font-semibold text-gray-900"
                                id="modal-title">Tambah proyek baru</label>
                            <div class="mt-2">
                                <input type="text" id="projectname" name="projectname"
                                    ...
                                    placeholder="Nama proyek" aria-labelledby="projectname" autocomplete="off" />
                            </div>
                        </div>
